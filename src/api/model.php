...
include './db.php';
	class model{
      public function insertar($id_arg, $nombre_arg, $apellidos_arg, $correo_arg, $sexo_arg){
			$modelo = new conectar();
			$conexion = $modelo->conection();
			$sql = "INSERT INTO usuarios(id_user, nombre, apellidos, direccion, correo, sexo)VALUES(:id, :nombre, :apellido, :direccion, :correo, :sexo)";
